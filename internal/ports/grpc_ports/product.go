...
type GrpcProductRepository interface {
	...
	ProductList(req *pb.ListProductsRequest) ([]*models.Product, int64, error)
	SaveUrlImage(req *pb.SaveImageRequest) (error)
	ProductGetByID(productId int64) (*models.Product, error)
	ValidateProducts(ctx context.Context, req *pb.ProductValidateRequest) ([]models.Product, error)
}
