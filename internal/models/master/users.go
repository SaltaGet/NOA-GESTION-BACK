...
func (o *User) GetTenants() TenantSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetTenants() TenantSlice {
	if r == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "email", "username", "address", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"first_name", "last_name", "email", "username"}
	userColumnsWithDefault    = []string{"id", "address", "created_at", "updated_at"}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "master: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "master: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "master: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "master: failed to check if users exists")
	}
...
func (o *User) Tenants(mods ...qm.QueryMod) tenantQuery {
	...
	queryMods = append(queryMods,
		...
		qm.Where("\"user_tenants\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadTenants(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.Select("\"tenants\".\"id\", \"tenants\".\"name\", \"tenants\".\"identifier\", \"tenants\".\"address\", \"tenants\".\"phone\", \"tenants\".\"email\", \"tenants\".\"cuit_pdv\", \"tenants\".\"is_active\", \"tenants\".\"plan_id\", \"tenants\".\"connection\", \"tenants\".\"expiration\", \"tenants\".\"accepted_terms\", \"tenants\".\"ip\", \"tenants\".\"date_accepted\", \"tenants\".\"created_at\", \"tenants\".\"updated_at\", \"tenants\".\"deleted_at\", \"a\".\"user_id\""),
		qm.From("\"tenants\""),
		qm.InnerJoin("\"user_tenants\" as \"a\" on \"tenants\".\"id\" = \"a\".\"tenant_id\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.Name, &one.Identifier, &one.Address, &one.Phone, &one.Email, &one.CuitPDV, &one.IsActive, &one.PlanID, &one.Connection, &one.Expiration, &one.AcceptedTerms, &one.IP, &one.DateAccepted, &one.CreatedAt, &one.UpdatedAt, &one.DeletedAt, &localJoinCol)
		if err != nil {
			return errors.Wrap(err, "failed to scan eager loaded results for tenants")
		}
		if err = results.Err(); err != nil {
			return errors.Wrap(err, "failed to plebian-bind eager loaded slice tenants")
		}
...
func (o *User) AddTenantsG(ctx context.Context, insert bool, related ...*Tenant) error {
...
// Appends related to o.R.Tenants.
// Sets related.R.Users appropriately.
func (o *User) AddTenants(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Tenant) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"user_tenants\" (\"user_id\", \"tenant_id\") values ($1, $2)"
...
// SetTenantsG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Users's Tenants accordingly.
// Replaces o.R.Tenants with related.
// Sets related.R.Users's Tenants accordingly.
// Uses the global database handle.
func (o *User) SetTenantsG(ctx context.Context, insert bool, related ...*Tenant) error {
	return o.SetTenants(ctx, boil.GetContextDB(), insert, related...)
}

// SetTenants removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Users's Tenants accordingly.
// Replaces o.R.Tenants with related.
// Sets related.R.Users's Tenants accordingly.
func (o *User) SetTenants(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Tenant) error {
	query := "delete from \"user_tenants\" where \"user_id\" = $1"
	values := []any{o.ID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	removeTenantsFromUsersSlice(o, related)
	if o.R != nil {
		o.R.Tenants = nil
	}

	return o.AddTenants(ctx, exec, insert, related...)
}

// RemoveTenantsG relationships from objects passed in.
// Removes related items from R.Tenants (uses pointer comparison, removal does not keep order)
// Sets related.R.Users.
// Uses the global database handle.
func (o *User) RemoveTenantsG(ctx context.Context, related ...*Tenant) error {
	return o.RemoveTenants(ctx, boil.GetContextDB(), related...)
}

// RemoveTenants relationships from objects passed in.
// Removes related items from R.Tenants (uses pointer comparison, removal does not keep order)
// Sets related.R.Users.
func (o *User) RemoveTenants(ctx context.Context, exec boil.ContextExecutor, related ...*Tenant) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"user_tenants\" where \"user_id\" = $1 and \"tenant_id\" in (%s)",
	...
	for _, rel := range related {
		for i, ri := range o.R.Tenants {
			...
			ln := len(o.R.Tenants)
			if ln > 1 && i < ln-1 {
				o.R.Tenants[i] = o.R.Tenants[ln-1]
			}
			o.R.Tenants = o.R.Tenants[:ln-1]
			break
		}
	}
...
func removeTenantsFromUsersSlice(o *User, related []*Tenant) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "master: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("master: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "master: unable to insert into users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("master: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "master: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("master: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("master: unable to upsert users, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userPrimaryKeyColumns) == 0 {
				return errors.New("master: unable to upsert users, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "master: unable to upsert users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("master: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "master: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("master: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "master: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "master: unable to delete all from user slice")
	}
...
func (o *User) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("master: no User provided for reload")
	}
...
func (o *UserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("master: empty UserSlice provided for reload all")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "master: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "master: unable to check if users exists")
	}
