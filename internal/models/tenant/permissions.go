...
var PermissionWhere = struct {
	...
	Details:     whereHelperstring{field: "\"permissions\".\"details\""},
	Group:       whereHelperstring{field: "\"permissions\".\"group\""},
	Environment: whereHelperstring{field: "\"permissions\".\"environment\""},
}
...
func (o *Permission) GetRoles() RoleSlice {
	if o == nil {
		return nil
	}
...
var (
	permissionAllColumns            = []string{"id", "code", "name", "details", "group", "environment"}
	permissionColumnsWithoutDefault = []string{"code", "name", "details", "group", "environment"}
...
func (q permissionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Permission, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tenant: failed to execute a one query for permissions")
	}
...
func (q permissionQuery) All(ctx context.Context, exec boil.ContextExecutor) (PermissionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "tenant: failed to assign all query results to Permission slice")
	}
...
func (q permissionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tenant: failed to count permissions rows")
	}
...
func (q permissionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "tenant: failed to check if permissions exists")
	}
...
func (o *Permission) Roles(mods ...qm.QueryMod) roleQuery {
	...
	queryMods = append(queryMods,
		...
		qm.Where("\"role_permissions\".\"permission_id\"=?", o.ID),
	)
...
func (permissionL) LoadRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybePermission any, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"roles\".\"id\", \"roles\".\"name\", \"a\".\"permission_id\""),
		qm.From("\"roles\""),
...
func (o *Permission) AddRolesG(ctx context.Context, insert bool, related ...*Role) error {
	return o.AddRoles(ctx, boil.GetContextDB(), insert, related...)
}
...
func (o *Permission) AddRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Role) error {
	...
	for _, rel := range related {
		query := "insert into \"role_permissions\" (\"permission_id\", \"role_id\") values ($1, $2)"
...
// Uses the global database handle.
func (o *Permission) SetRolesG(ctx context.Context, insert bool, related ...*Role) error {
	return o.SetRoles(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Permission) RemoveRolesG(ctx context.Context, related ...*Role) error {
	return o.RemoveRoles(ctx, boil.GetContextDB(), related...)
}
...
func (o *Permission) RemoveRoles(ctx context.Context, exec boil.ContextExecutor, related ...*Role) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"role_permissions\" where \"permission_id\" = $1 and \"role_id\" in (%s)",
...
func FindPermissionG(ctx context.Context, iD int64, selectCols ...string) (*Permission, error) {
...
func FindPermission(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Permission, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tenant: unable to select from permissions")
	}
...
func (o *Permission) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("tenant: no permissions provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "tenant: unable to insert into permissions")
	}
...
func (o *Permission) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("tenant: unable to update permissions, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to update permissions row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tenant: failed to get rows affected by update for permissions")
	}
...
func (q permissionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to update all for permissions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to retrieve rows affected for permissions")
	}
...
func (o PermissionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to update all in permission slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to retrieve rows affected all in update all permission")
	}
	return rowsAff, nil
}
...
func (o *Permission) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("tenant: no permissions provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("tenant: unable to upsert permissions, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(permissionPrimaryKeyColumns) == 0 {
				return errors.New("tenant: unable to upsert permissions, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "tenant: unable to upsert permissions")
	}
...
func (o *Permission) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("tenant: no Permission provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to delete from permissions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tenant: failed to get rows affected by delete for permissions")
	}
...
func (q permissionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("tenant: no permissionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to delete all from permissions")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tenant: failed to get rows affected by deleteall for permissions")
	}
...
func (o PermissionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tenant: unable to delete all from permission slice")
	}
...
func (o *Permission) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("tenant: no Permission provided for reload")
	}
...
func (o *PermissionSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("tenant: empty PermissionSlice provided for reload all")
	}
...
func (o *PermissionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "tenant: unable to reload all in PermissionSlice")
	}
...
func PermissionExistsG(ctx context.Context, iD int64) (bool, error) {
...
func PermissionExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "tenant: unable to check if permissions exists")
	}
