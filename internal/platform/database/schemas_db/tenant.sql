...
CREATE TABLE IF NOT EXISTS public.expense_buy_items (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.expense_buy_items_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.expense_buys (
    id bigint NOT NULL,
    member_id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.expense_buys_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.expense_others (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.expense_others_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.income_ecommerce_items (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.income_ecommerce_items_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.income_ecommerces (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.income_ecommerces_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.income_others (
    id bigint NOT NULL,
    point_sale_id bigint,
    member_id bigint,
    cash_register_id bigint,
...
CREATE SEQUENCE IF NOT EXISTS public.income_others_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE IF NOT EXISTS public.income_sale_items_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.income_sales (
    id bigint NOT NULL,
    point_sale_id bigint NOT NULL,
    member_id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.income_sales_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.member_point_sales (
    point_sale_id bigint NOT NULL,
    member_id bigint NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.movement_stocks (
    id bigint NOT NULL,
    member_id bigint NOT NULL,
    product_id bigint NOT NULL,
    amount numeric NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.movement_stocks_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.pay_expense_buys (
    id bigint NOT NULL,
    expense_buy_id bigint NOT NULL,
    cash_register_id bigint,
    total numeric NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.pay_expense_buys_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.pay_expense_others (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.pay_expense_others_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.pay_incomes (
    id bigint NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.pay_incomes_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE IF NOT EXISTS public.point_sales_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE IF NOT EXISTS public.stock_point_sales (
    id bigint NOT NULL,
    product_id bigint NOT NULL,
    point_sale_id bigint NOT NULL,
    stock numeric DEFAULT 0 NOT NULL,
...
CREATE SEQUENCE IF NOT EXISTS public.stock_point_sales_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE IF NOT EXISTS public.type_expenses_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE IF NOT EXISTS public.type_incomes_id_seq
    START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
EXCEPTION WHEN duplicate_object OR sqlstate '42P07' OR sqlstate '42P16' THEN NULL; END $$;
...
DO $$ BEGIN
    ALTER TABLE ONLY public.permissions ADD CONSTRAINT uni_permissions_code UNIQUE (code);
EXCEPTION WHEN duplicate_object OR sqlstate '42P07' OR sqlstate '42P16' THEN NULL; END $$;
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_transaction_id ON public.audit_logs USING btree (transaction_id);
CREATE INDEX IF NOT EXISTS idx_categories_delete_at ON public.categories USING btree (delete_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_categories_name ON public.categories USING btree (name);
CREATE INDEX IF NOT EXISTS idx_clients_deleted_at ON public.clients USING btree (deleted_at);
CREATE INDEX IF NOT EXISTS idx_income_ecommerce_items_income_ecommerce_id ON public.income_ecommerce_items USING btree (income_ecommerce_id);
CREATE INDEX IF NOT EXISTS idx_income_ecommerce_items_product_id ON public.income_ecommerce_items USING btree (product_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_income_ecommerces_external_reference ON public.income_ecommerces USING btree (external_reference);
CREATE INDEX IF NOT EXISTS idx_income_ecommerces_payment_id ON public.income_ecommerces USING btree (payment_id);
CREATE INDEX IF NOT EXISTS idx_income_sale_items_income_sale_id ON public.income_sale_items USING btree (income_sale_id);
CREATE INDEX IF NOT EXISTS idx_income_sale_items_product_id ON public.income_sale_items USING btree (product_id);
CREATE INDEX IF NOT EXISTS idx_members_deleted_at ON public.members USING btree (deleted_at);
CREATE INDEX IF NOT EXISTS idx_pay_expense_buys_cash_register_id ON public.pay_expense_buys USING btree (cash_register_id);
CREATE INDEX IF NOT EXISTS idx_pay_expense_buys_expense_buy_id ON public.pay_expense_buys USING btree (expense_buy_id);
CREATE INDEX IF NOT EXISTS idx_pay_expense_others_cash_register_id ON public.pay_expense_others USING btree (cash_register_id);
CREATE INDEX IF NOT EXISTS idx_pay_expense_others_expense_other_id ON public.pay_expense_others USING btree (expense_other_id);
CREATE INDEX IF NOT EXISTS idx_pay_incomes_cash_register_id ON public.pay_incomes USING btree (cash_register_id);
CREATE INDEX IF NOT EXISTS idx_pay_incomes_client_id ON public.pay_incomes USING btree (client_id);
CREATE INDEX IF NOT EXISTS idx_pay_incomes_income_sale_id ON public.pay_incomes USING btree (income_sale_id);
CREATE INDEX IF NOT EXISTS idx_point_sales_delete_at ON public.point_sales USING btree (delete_at);
CREATE UNIQUE INDEX IF NOT EXISTS idx_point_sales_name ON public.point_sales USING btree (name);
CREATE UNIQUE INDEX IF NOT EXISTS idx_products_code ON public.products USING btree (code);
